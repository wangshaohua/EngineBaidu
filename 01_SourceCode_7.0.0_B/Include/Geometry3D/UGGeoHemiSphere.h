// UGHemiSphere.h: interface for the UGHemiSphere class.
//
//////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
//                    _   _   ____   ____                    
...
#if !defined(AFX_UGHEMISPHERE_H__E92EE95B_E669_4C8F_AB6E_BC1A843192CD__INCLUDED_)
#define AFX_UGHEMISPHERE_H__E92EE95B_E669_4C8F_AB6E_BC1A843192CD__INCLUDED_
...
namespace UGC
{
class GEOMETRY3D_API UGGeoHemiSphere : public UGGeometry3D  
{
public:
	//! \brief 构造函数。
	UGGeoHemiSphere();
...
public:
	...
	//! \brief 得到三维几何对象的内点
	UGPoint3D GetInnerPoint3D() const;

	//! \brief 拷贝复制对象
	//! \param geoCircle 已有对象
	//! \return 已有对象非法, 返回false
	UGbool Make(const UGGeoHemiSphere& geoSphere);
...
#endif // !defined(AFX_UGHEMISPHERE_H__E92EE95B_E669_4C8F_AB6E_BC1A843192CD__INCLUDED_)
