// UGGeoCircle3D.h: interface for the UGGeoCircle3D class.
//
//////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
//                    _   _   ____   ____                    
...
#if !defined(AFX_UGGEOCIRCLE3D_H__7BCEE0A5_1102_400F_A8C0_CC21CE7B10EB__INCLUDED_)
#define AFX_UGGEOCIRCLE3D_H__7BCEE0A5_1102_400F_A8C0_CC21CE7B10EB__INCLUDED_
...
namespace UGC
{
class GEOMETRY3D_API UGGeoCircle3D : public UGGeometry3D  
{
public:
	//! \brief 构造函数。 
	UGGeoCircle3D();
...
public:
	...
	UGbool Make(const UGGeoCircle3D& geoCircle3D);
	...
	UGbool Make(const UGPoint2D& pnt1, const UGPoint2D& pnt2, const UGPoint2D& pnt3, UGdouble z);    

	//! \brief 两点(直径上的两点)构圆。
	//! \param pnt1 [in] 第一个点。
	//! \param pnt2 [in] 第二个点。
	//! \return 返回true。
	UGbool Make(const UGPoint2D& pnt1, const UGPoint2D& pnt2, UGdouble z);    
...
#endif // !defined(AFX_UGGEOCIRCLE3D_H__7BCEE0A5_1102_400F_A8C0_CC21CE7B10EB__INCLUDED_)
