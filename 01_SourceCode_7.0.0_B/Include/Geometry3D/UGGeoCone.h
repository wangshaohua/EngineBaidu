// UGGeoCone.h: interface for the UGGeoCone class.
//
//////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
//                    _   _   ____   ____                    
...
#if !defined(AFX_UGGEOCONE1_H__F3CC6A64_9ACC_4430_962A_49D3029070F0__INCLUDED_)
#define AFX_UGGEOCONE1_H__F3CC6A64_9ACC_4430_962A_49D3029070F0__INCLUDED_
...
namespace UGC
{
class GEOMETRY3D_API UGGeoCone : public UGGeometry3D  
{
public:
	//! \brief 构造函数。
	UGGeoCone();
...
public:
	...
	UGbool Make(const UGGeoCone& geoCone);

	//! \brief 通过圆心和半径来构造圆。
	//! \param pntCenter [in] 圆心。
	//! \param dRadius [in] 半径。
	//! \return 半径小于0, 返回false。
	UGbool Make(const UGPoint3D &pntCenter, UGdouble dRadius, UGdouble dHeight);    
	...
	UGbool Make(const UGPoint2D& pnt1, const UGPoint2D& pnt2, const UGPoint2D& pnt3, UGdouble z, UGdouble dHeight);    

	//! \brief 两点(直径上的两点)构圆。
	//! \param pnt1 [in] 第一个点。
	//! \param pnt2 [in] 第二个点。
	//! \return 返回true。
	UGbool Make(const UGPoint2D& pnt1, const UGPoint2D& pnt2, UGdouble z, UGdouble dHeight);    
...
#endif // !defined(AFX_UGGEOCONE1_H__F3CC6A64_9ACC_4430_962A_49D3029070F0__INCLUDED_)
