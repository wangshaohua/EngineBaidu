...
#if !defined(AFX_UGDATASETRASTERBAIDUMAPS_H__7681AA6D_BDCB_4A18_A9A3_EC39CEBB7BE4__INCLUDED_)
#define AFX_UGDATASETRASTERBAIDUMAPS_H__7681AA6D_BDCB_4A18_A9A3_EC39CEBB7BE4__INCLUDED_
...
namespace UGC
{
	...
	class ENGINEBAIDUMAPS_API UGDatasetRasterBaiduMaps : public UGDatasetRasterWeb 
	{
		friend class UGDataSourceBaiduMap;
	public:
		UGDatasetRasterBaiduMaps();
		virtual ~UGDatasetRasterBaiduMaps();
...
#endif // !defined(AFX_UGDATASETRASTERBAIDUMAPS_H__7681AA6D_BDCB_4A18_A9A3_EC39CEBB7BE4__INCLUDED_)