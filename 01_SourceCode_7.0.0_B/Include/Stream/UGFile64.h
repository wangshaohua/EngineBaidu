...
namespace UGC{
#ifdef SYMBIAN60
class STREAM_APIC UGFile64 :  public UGStream
#else
class STREAM_API UGFile64 :  public UGStream
#endif
{

public:
	//! \brief 构造函数
	STREAM_APIF UGFile64();
	//! \brief 析构函数
	virtual STREAM_APIF ~UGFile64();

private:
#ifndef SYMBIAN60
	STREAM_APIF UGFile64(const UGFile64& file64);
	STREAM_APIF UGFile64& operator=(const UGFile64& file64);
#endif
...
public:
	...
	//! \brief 判断当前文件是否打开,
	//! \return 文件是否打开
	STREAM_APIF UGbool IsOpen() const{return m_pStdFilePoint != NULL;}
...
#ifdef SYMBIAN60
class STREAM_APIC UGFileLock : public UGFile64
{
public:
	//! \brief 构造函数
	STREAM_APIF UGFileLock();
	//! \brief 析构函数
	virtual STREAM_APIF ~UGFileLock();


	STREAM_APIF UGbool WriteByPos(UGulong nGeoPosition, const void* pContext,UGSizeT nSize);


	STREAM_APIF UGbool ReadByPos(UGulong nGeoPosition, void* pContext,UGSizeT nSize);


	STREAM_APIF	void LoadByPos(UGulong nGeoPosition, UGuint* pContext,UGSizeT nCount);


	STREAM_APIF void SaveByPos(UGulong nGeoPosition, const UGuint* pContext,UGSizeT nCount);
...
#endif // !defined(AFX_UGFile64_H__52E31DC2_8E36_4136_9D5F_C372D533EEC4__INCLUDED_)
