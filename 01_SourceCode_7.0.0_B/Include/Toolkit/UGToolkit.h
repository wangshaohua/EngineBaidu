...
//! \brief 获取SuperMap.xml中的配置，文本是否使用ClearType方式进行反走样，该设置仅对Windows有效
extern TOOLKIT_API UGbool UGIsSupportClearType();
//! \brief 设置文本是否使用ClearType方式进行反走样
extern TOOLKIT_API void UGSetSupportClearType(UGbool bSupportClearType = TRUE);
}
