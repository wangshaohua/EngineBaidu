...
#ifndef __UGKMLIMPORTPARAMS_H__
#define __UGKMLIMPORTPARAMS_H__
...
//! \brief Dxf的导入参数配置。
//! \remarks 备注信息。
class FILEPARSER_API UGKMLImportParams : public UGVectorImportParams
{
public:
	//! \brief 构造函数。
	//! \remarks 。
...
public:
	...
	//! \remarks 。
	//! \attention 。
	virtual inline UGint GetFileType() const	{ return UGFileType::KML; }
...
protected:
	//! \brief 是否导入可见对象，默认为TRUE.
	UGbool m_bImportVisible;//
};

//! \brief Dxf的导出参数配置。
//! \remarks 备注信息。
class FILEPARSER_API UGKMLExportParams : public UGVectorExportParams
{
public:
	//! \brief 构造函数。
	//! \remarks 。
