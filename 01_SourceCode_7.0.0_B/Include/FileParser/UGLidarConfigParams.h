...
#if !defined(AFX_UG_LIDAR_FILEPARSERCONFIGPARAMS_H__INCLUDED_)
#define AFX_UG_LIDAR_FILEPARSERCONFIGPARAMS_H__INCLUDED_
...
namespace UGC 
{
	...
	//! \brief shp的导入参数配置。
	class FILEPARSER_API UGLidarImportParams : public UGVectorImportParams
	{
	public:
		//! \brief 构造函数。
		UGLidarImportParams();
	...
	public:
		...
		//! \brief 重载获取文件格式类型的函数。
		virtual inline UGint GetFileType() const	{ return UGFileType::Lidar; }
