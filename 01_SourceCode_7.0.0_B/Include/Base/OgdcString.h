...
public:
	...
	struct ShowUnicodeString	// 这个结构体很有意思，既能解决UnicodeString内容的显示问题，又能为UnicodeString初始分配内存
								//修改了实现，和icu50同步，2013.5.27 by 张艳良，姜日升
	{
		void		*pString;
		void		*pVftable;	
...
private:
	...
	union   //定义匿名枚举,方便显示UnicodeString的真实内容,请勿操作struct ShowUnicodeString中的内容,结构体的具体内容需要与ICU的类成员同步更新  add by jiangrs，zhangyl，zhangkai!
	{		
