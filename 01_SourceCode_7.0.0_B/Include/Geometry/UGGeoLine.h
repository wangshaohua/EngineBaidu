...
public:
	...
	//构造出 第lSubIndex个子对象，lSubIndex从0到nSubCount-1；pGeoLine传入时应为null，用户必须在外部用完后显形删除；
	...
	//从SFC53中移入		add by shuxl	2009.11.5
	//! \brief	从指定的子对象的指定位置开始去掉 lPointCount 个节点
	//! \param 参数：lSubObjID	目标子对象
	//! \param 	lPointID	删除的起始位置
	//! \param 	lPointCount	删除的点数
	//! \return 成功返回TRUE, 失败返回FALSE
...
public:
	...
	//! \brief 在线对象上插入一个点	
	//! \param nSubIndex 字对象索引号
	//! \param nPointIndex 子对象上插入点的索引号
	//! \param nPointIndex 待插入的点坐标
	//! \return 
